...
app.delete('/deleteclass/:id', (req, res) => {
  ...
  const sql = "DELETE FROM `class` WHERE CID = ?";
  const values = [subjectId];
...
app.post('/addstaff',(req,res)=>{
  const sql = 'INSERT INTO `staff`(`TID`, `TNAME`, `TPASS`, `QUAL`, `SAL`, `PNO`, `MAIL`, `PADDR`, `IMG`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]','[value-8]','[value-9]')'
})
